...
pub fn run(pretty: bool) {
    let resp = HelpResponse {
        ...
        description: "Agentic weather platform — JSON API for AI agents. All output is valid JSON to stdout. Errors go to stderr as {\"error\": \"...\"}.",
        output_format: "JSON",
        commands: vec![
            CommandDef {
                name: "models",
            ...
            CommandDef {
                ...
                example: "wx point --lat 35.2 --lon -97.4 --model hrrr --var temperature --level surface",
            },
            CommandDef {
                name: "sounding",
                ...
                example: "wx sounding --lat 35.2 --lon -97.4 --model hrrr",
            },
            CommandDef {
                name: "severe",
                description: "Severe weather assessment for a region (by state or lat/lon + radius)",
                args: vec![
            ...
            CommandDef {
                ...
                example: "wx download --model hrrr --run latest --fhour 0 --output ./data/",
            },
            CommandDef {
                name: "decode",
                ...
                example: "wx decode --file data/hrrr.grib2 --list",
            },
            CommandDef {
                name: "metar",
            ...
            CommandDef {
                ...
                example: "wx station --id KOKC",
            },
            CommandDef {
                name: "raob",
                description: "Fetch real radiosonde sounding from University of Wyoming with derived indices (CAPE, shear, SRH, STP, etc.)",
                args: vec![
                ...
                example: "wx raob --station OUN --hour 12",
            },
            CommandDef {
                name: "forecast",
                ...
                example: "wx forecast --lat 35.2 --lon -97.4",
            },
            CommandDef {
                name: "conditions",
                ...
                example: "wx conditions --lat 35.2 --lon -97.4",
            },
            CommandDef {
                name: "history",
                ...
                example: "wx history --station KOKC --hours 24",
            },
            CommandDef {
                name: "hazards",
                ...
                example: "wx hazards --lat 35.2 --lon -97.4",
            },
            CommandDef {
                name: "radar",
                description: "Download + parse latest NEXRAD Level 2 radar volume scan",
                args: vec![
                    ArgDef { name: "--site", arg_type: "string", required: false, default: None, description: "NEXRAD site ID (e.g., KTLX, KFWS)" },
                    ArgDef { name: "--lat", arg_type: "float", required: false, default: None, description: "Latitude (finds nearest radar site)" },
                    ArgDef { name: "--lon", arg_type: "float", required: false, default: None, description: "Longitude (finds nearest radar site)" },
                ],
                example: "wx radar --site KTLX",
            },
            CommandDef {
                name: "commands",
